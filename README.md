...
- 검색어로 `postCSS Sorting:Run` 선택 : Shift + `
...
- `웹브라우저 F12` 활용
- `Dock 위치를 조절` or `디바이스 아이콘`으로 화면을 띄우고 진행
...
- 실습
  - css 폴더 / `test.scss파일` 생성
  - VSCode 하단에 watch Sass를 클릭 -> Watching으로 변경
